...
/usr/local/bin/wxmap -T "NOAA ${bird}" -H ~/wxsat/weather.txt -L "42.241/-75.98/264" -p0 -o "\$mapdate" ~/wxsat/noaa${bird}map.png
...
cp ~/wxsat/recordings/NOAA${bird}-\$recdate.* /media/cloud/coop/
cp ~/wxsat/images/NOAA${bird}-****-\$recdate.* /media/cloud/coop/
~/wxsat/tweet.sh upload ~/wxsat/images/NOAA${bird}-HVCT-\$recdate.*
~/wxsat/tweet.sh upload ~/wxsat/images/NOAA${bird}-MCIR-\$recdate.*
EOF
#schedule at
